...
const CurvedLoop = ({
  ...
  return (
    <div
      className="py-6 md:py-16 flex items-center justify-center w-full bg-slate-50"
    ...
    >
      <svg
        className="select-none w-full overflow-visible block aspect-[100/8] md:aspect-[100/12] text-9xl md:text-5xl lg:text-6xl font-medium tracking-wider text-slate-600"
      ...
      >
        ...
        {ready && (
          <text xmlSpace="preserve" className={`fill-slate-600 ${className ?? ""}`}>
